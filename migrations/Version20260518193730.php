 ...
 */
final class Version20260518193730 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP color_id, DROP product_family');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD color_id INT DEFAULT NULL, ADD product_family VARCHAR(255) DEFAULT NULL');
