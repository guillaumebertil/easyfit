...
/** Couleur disponible avec son code hexadécimal, partagée entre plusieurs produits et variantes. */
...
class Color
{
     ...
     */
    #[ORM\OneToMany(targetEntity: ProductVariant::class, mappedBy: 'Color')]
